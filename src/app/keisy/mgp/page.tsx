...
export const metadata: Metadata = {
  title: "Кейс «Сеть магазинов горящих путёвок» × «Навылет! AI» — как сеть из 396 офисов внедряет ИИ-турменеджер",
  description:
    "Стратегическое партнёрство «Навылет! AI» и МГП — Сети магазинов горящих путёвок (27 лет на рынке, 396 офисов, 5+ млн обслуженных туристов). МГП — первая туристическая сеть в России, внедрившая ИИ-турменеджер в реальную работу с клиентами.",
  keywords: [
    ...
    "ИИ-турменеджер кейс внедрения",
  ],
  alternates: { canonical: "/keisy/mgp" },
  openGraph: {
    title:
      "Кейс МГП × «Навылет! AI» — ИИ-турменеджер в сети из 396 офисов",
    description:
  ...
  twitter: {
    ...
    title: "Кейс МГП × «Навылет! AI» — ИИ-турменеджер в сети из 396 офисов",
    description:
...
const partnershipFacts = [
  ...
  "Первая туристическая сеть России, внедрившая ИИ-турменеджер в реальную работу с клиентами",
...
const caseJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      headline:
        "Кейс «Сеть магазинов горящих путёвок» × «Навылет! AI» — ИИ-турменеджер в сети из 396 офисов",
      description:
        "Стратегическое партнёрство «Навылет! AI» и МГП — Сети магазинов горящих путёвок: 27 лет на рынке, 396 офисов, 5+ млн обслуженных туристов. МГП — первая туристическая сеть в России, внедрившая ИИ-турменеджер.",
        ...
        <article>
          <header className="mx-auto max-w-5xl px-5 py-10 sm:px-6 sm:py-14 lg:px-8">
            ...
            <h1 className="font-display text-3xl font-bold leading-tight text-heading sm:text-4xl lg:text-5xl">
              ...
              <span className="text-accent">ИИ-турменеджер «Навылет! AI»</span>
            </h1>
            <p className="mt-5 max-w-3xl text-base text-body sm:text-lg">
              ...
              ИИ-турменеджер «Навылет! AI» в реальную работу с клиентами и
            ...
            <div className="mx-auto max-w-3xl px-5 py-14 sm:px-6 lg:px-8 lg:py-16">
              ...
              <div className="prose prose-base mt-5 max-w-none text-body">
                ...
                <p>
                  ...
                  внедрение ИИ-турменеджера в российскую туристическую сеть.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="overflow-hidden rounded-2xl border border-blue-subtle/50 bg-white">
                ...
                <div className="p-5">
                  ...
                  <p className="mt-2 text-sm text-body">
                    Генеральный директор МГП Сергей Агафонов и руководитель
                    проекта «Навылет! AI» Лукиан Силагадзе обсудили влияние
          ...
          <section className="bg-surface-alt">
            <div className="mx-auto max-w-3xl px-5 py-14 sm:px-6 lg:px-8 lg:py-16">
              <h2 className="font-display text-2xl font-bold text-heading sm:text-3xl">
                Почему сеть из 396 офисов выбирает ИИ-турменеджер
              </h2>
          ...
          <section className="mx-auto max-w-3xl px-5 py-14 sm:px-6 lg:px-8 lg:py-16">
            ...
            <p className="mt-5 text-base text-body">
              ...
              основатели проекта «Навылет! AI» Лукиан Силагадзе и Евгений
              Ребеко были удостоены почётной благодарности за «Вклад в
              развитие ИИ-технологий в туризме» от вице-президента Российского
              союза туриндустрии Юрия Барзыкина и заместителя председателя
              комитета Госдумы по туризму Натальи Костенко. Партнёрство с МГП
              стало одной из ключевых причин такого признания.
            </p>
            <div className="mt-6">
              <Link
                href="/#events"
