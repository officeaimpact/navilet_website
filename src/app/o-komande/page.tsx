...
export const metadata: Metadata = {
  ...
  description:
    "ООО «ИИМПАКТ ПЛЮС» — российский разработчик ИИ-ассистента «Навылет! AI». Эксперты по применению искусственного интеллекта в туризме при Комитете ТПП РФ, благодарность Российского союза туриндустрии и Госдумы РФ.",
  keywords: [
    "о компании Навылет",
    "ИИМПАКТ ПЛЮС",
