...
export const metadata: Metadata = {
  title: "ИИ для турагентства — «Навылет! AI» подбирает туры и продаёт 24/7",
  description:
    "ИИ-ассистент для турагентств: не пропускает ночные заявки, подбирает туры за секунды, отвечает на 80% вопросов клиентов сам. Менеджер подключается только когда клиент готов бронировать. Подключение за 1 день, 7 дней бесплатно.",
  keywords: [
    "ИИ для турагентства",
...
const outcomes = [
  ...
  "Подключение за 1 рабочий день — одна строка кода и настройка в личном кабинете",
...
const recommendedTariffs = [
  {
    ...
    rec: "Тариф «Старт»",
    price: "3 290 ₽/мес",
    detail: "50 диалогов в месяц. Инсталляция 1 000 ₽.",
  ...
  },
  {
    ...
    rec: "Тариф «Стандарт»",
    price: "5 290 ₽/мес",
    detail: "120 диалогов в месяц. Инсталляция 3 000 ₽.",
  ...
  },
  {
    ...
    rec: "Тариф «Бизнес»",
    price: "7 990 ₽/мес",
    detail: "200 диалогов в месяц. Инсталляция 5 000 ₽.",
...
const audienceJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "ИИ-турменеджер «Навылет! AI» для турагентств",
      ...
      description:
        "Готовая ИИ-автоматизация для турагентств. Виджет на сайте подбирает туры, консультирует и отвечает на типовые вопросы клиентов 24/7. Интеграция с Tourvisor. Подключение за 1 день.",
    ...
    <>
      ...
      <main>
        ...
        <section className="mx-auto max-w-3xl px-5 py-16 text-center sm:px-6 lg:px-8 lg:py-20">
          <h2 className="font-display text-3xl font-bold text-heading sm:text-4xl">
            Попробуйте на своём сайте — 7 дней{" "}
            <span className="text-accent">бесплатно</span>
          </h2>
          <p className="mt-4 text-base text-body sm:text-lg">
            Без карты, без сложных договоров. Одна строка кода — и ИИ-ассистент
