      ...
      <main>
        ...
        <section className="mx-auto max-w-4xl px-5 py-10 text-center sm:px-6 sm:py-14 lg:px-8">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base text-body sm:text-lg">
            Клиент редко решает один: тур обсуждают с женой, мужем и родителями.
            Ассистент собирает подобранные варианты в отдельную страницу под
            вашим брендом — с фото отелей, вариантами перелёта и живыми ценами.
            Клиент пересылает ссылку в семейный чат, а вы видите, что открыли и
            где появилась заявка.
          </p>

          <div className="mx-auto mt-9 grid max-w-2xl grid-cols-3 gap-3">
            {[
              { stat: "7 дней", label: "живёт ссылка у клиента" },
              { stat: "0", label: "переходов на чужие сайты" },
